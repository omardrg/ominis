...
/*
	function ominis_scripts() {
		...
		wp_enqueue_script( 'ominis-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
?>
	<div class="wrap">
		<h2><?php _e('Ominis Theme: Instructions <small>2.0.0</small>','ominis');?></h2>
